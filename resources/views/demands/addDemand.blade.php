        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card" style=" border-top-left-radius: 50px; border-radius: 150px; ">
                    ...
                    <p><button style="border-bottom-left-radius: 33px; border-bottom-right-radius: 33px;  width: 200px;"><span class="fa fa-phone fa-2x" style="color: red; margin-right: 10px;"></span>{{ $offer->users->tel }}</button></p>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card" style="margin-top: 25px">
                ...
                <form method="post" action="{{ route('demands.store') }}">
                    @csrf

                    <div class="card-body row">
                        <input type="hidden" required name="id">
                        <input type="hidden" required name="offers_id" value="{{ $offer->id }}">

                        <div class="form-group col-md-12 required ">
                            <label for="budget">Budget</label>
                            <input name="budget" class="form-control" placeholder="Budget" />
                        </div>
